...
def product_detail(request, category_slug, product_slug):
    ...
    context = {
        ...
        'reviews': reviews,
        'average_review': single_product.average_review,
    }
...
def search(request):
    if 'keyword' in request.GET:
        ...
        if keyword:
            products = Product.objects.filter(Q(product_name__icontains=keyword) | Q(
                description__icontains=keyword)).order_by("-created_date")
            product_count = products.count()
            context = {
                'products': products,
                'product_count': product_count,
